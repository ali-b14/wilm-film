...
import com.wilmfilm.app.repository.VideoRepository;
import com.wilmfilm.app.service.dto.VideoDTO;
import com.wilmfilm.app.service.mapper.VideoMapper;
...
class VideoResourceIT {
    ...
    public static Video createEntity(EntityManager em) {
        Video video = new Video().url(DEFAULT_URL).urlContentType(DEFAULT_URL_CONTENT_TYPE);
        return video;
    }
    ...
    public static Video createUpdatedEntity(EntityManager em) {
        Video video = new Video().url(UPDATED_URL).urlContentType(UPDATED_URL_CONTENT_TYPE);
        return video;
    }
    ...
    void putExistingVideo() throws Exception {
        ...
        updatedVideo.url(UPDATED_URL).urlContentType(UPDATED_URL_CONTENT_TYPE);
    ...
    void fullUpdateVideoWithPatch() throws Exception {
        ...
        partialUpdatedVideo.url(UPDATED_URL).urlContentType(UPDATED_URL_CONTENT_TYPE);
